...
const BUSINESS_L1 = {
  intro: "Tu veux lancer ton parfum. Avant de fixer un prix, tu dois savoir ce que ça coûte vraiment de fabriquer une bouteille.",
  question: "Clique sur tout ce qui est un coût de production :",
  elements: [
    { nom: "Eau florale de rose", estUnCout: true,  explication: "C'est une matière première — tu la paies à chaque bouteille produite." },
    { nom: "Flacon en verre",     estUnCout: true,  explication: "L'emballage a un coût direct sur chaque unité fabriquée." },
    { nom: "Étiquette imprimée",  estUnCout: true,  explication: "Même une petite étiquette coûte quelque chose à produire." },
    { nom: "Loyer du local",      estUnCout: true,  explication: "Même si tu ne produis rien ce mois, tu paies quand même le loyer." },
    { nom: "L'idée du fondateur", estUnCout: false, explication: "Une idée n'a pas de coût direct de production — c'est de la valeur intellectuelle, pas une charge." },
    { nom: "Le nom de la marque", estUnCout: false, explication: "Le nom lui-même ne coûte rien à fabriquer — sauf si tu le déposes légalement (et là c'est un coût juridique, pas de production)." }
  ],
  feedbackSucces: "Exactement. Tout ce qui consomme des ressources pour fabriquer = un coût.",
  feedbackEchec: "Pas tout à fait. Pense à ce qui disparaît ou se consomme quand tu fabriques une bouteille."
};

const BUSINESS_L2 = {
  scenario: "Tu produis d'abord 10 bouteilles, puis tu décides d'en produire 100. Glisse chaque charge dans la bonne colonne.",
  charges: [
    { nom: "Loyer du laboratoire",                  montant: "400 TND/mois",            type: "fixe",     explication: "Que tu fasses 1 ou 1000 bouteilles, tu paies 400 TND. C'est un coût fixe." },
    { nom: "Huile essentielle de jasmin",           montant: "3,5 TND par bouteille",   type: "variable", explication: "Plus tu produis, plus tu en achètes. Le total change avec la quantité." },
    { nom: "Flacons en verre",                      montant: "5 TND par unité",         type: "variable", explication: "1 bouteille = 1 flacon. Le coût grandit avec ta production." },
    { nom: "Étiquettes",                            montant: "0,8 TND par unité",       type: "variable", explication: "Coût direct par unité produite." },
    { nom: "Abonnement logiciel comptabilité",      montant: "35 TND/mois",             type: "fixe",     explication: "Tu paies ce montant peu importe ce que tu produis." },
    { nom: "Électricité du labo",                   montant: "Varie selon usage",       type: "variable", piege: true, explication: "Piège ! L'électricité ressemble à un fixe mais elle augmente avec la production. C'est un coût variable (ou semi-variable)." },
    { nom: "Salaire de ton assistant (temps plein)",montant: "800 TND/mois",            type: "fixe",     explication: "Un salaire mensuel fixe ne change pas avec la quantité produite." },
    { nom: "Emballage cadeau (sur commande)",       montant: "2 TND par commande",      type: "variable", explication: "Seulement quand un client le demande — c'est un coût variable à la commande." }
  ],
  regleARetenir: "Coût fixe = ne change pas avec la quantité. Coût variable = grandit avec chaque unité produite."
};
...
const BUSINESS_L3 = {
  donnees: {
    lot: 50,
    couts: [
      { nom: "Huile essentielle", total: 175, unitaire: 3.5 },
      { nom: "Flacons",           total: 250, unitaire: 5 },
      { nom: "Étiquettes",        total: 40,  unitaire: 0.8 },
      { nom: "Quote-part loyer",  total: 80,  unitaire: 1.6 },
      { nom: "Emballage",         total: 60,  unitaire: 1.2 }
    ],
    totalLot: 605,
    coutUnitaire: 12.1
  },
  questions: [
    {
      enonce: "Quel est le coût total pour produire les 50 bouteilles ?",
      reponseCorrecte: 605,
      feedbackErreur: "Additionne tous les postes de coûts. Loyer compris !",
      feedbackSucces: "Parfait. 605 TND pour 50 bouteilles."
    },
    {
      enonce: "Quel est le prix de revient d'une seule bouteille ?",
      reponseCorrecte: 12.1,
      feedbackErreur: "Divise le coût total par le nombre de bouteilles : 605 ÷ 50.",
      feedbackSucces: "Exact. 12,1 TND par bouteille."
    },
    {
      enonce: "Parmi ces 3 prix de vente, lequel te donne au moins 30% de marge ?",
      choix: [
        { prix: 14, marge: "13,6%", correct: false },
        { prix: 18, marge: "32,6%", correct: true  },
        { prix: 16, marge: "24,2%", correct: false }
      ],
      feedbackSucces: "Oui. À 18 TND, ta marge est de (18-12,1)/12,1 = 32,6%. Au-dessus des 30%."
    }
  ],
  piegeClassique: "Oublier de diviser par le nombre d'unités — tu obtiens le coût du lot, pas le coût unitaire."
};
