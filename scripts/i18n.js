...
const I18N = (() => {
    ...
    const DICT = {
        ...
        'social.levels': { ar: 'مستوى تفاعلي', fr: '?????x interactifs' },
        ...
        'common.complete_sub': { ar: 'مستوى سدّيتو', fr: '????? terminé' },
        'common.xp_earned': { ar: 'حبة جوز ربحت', fr: 'XP gagnés' },

        // Float cards (home hero)
        'float.completed': { ar: 'مستوى 1 سدّيتو', fr: '????? 1 complété' },
    ...
    function makeSwitcher(opts = {}) {
        ...
        wrap.innerHTML = `
            <button class="lang-btn ${current === 'ar' ? 'active' : ''}" data-lang="ar" aria-label="دارجة">
